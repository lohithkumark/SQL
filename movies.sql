...
(1, 'Baahubali: The Beginning', 'Action', '2015-07-10', 'S. S. Rajamouli', 159, 'Telugu', 8.1, 1800000000, 600000000000),
(2, 'Dangal', 'Drama', '2016-12-23', 'Nitesh Tiwari', 161, 'Hindi', 8.4, 700000000, 387000000),
(3, '3 Idiots', 'Comedy', '2009-12-25', 'Rajkumar Hirani', 170, 'Hindi', 8.4, 550000000, 39200000),
(4, 'Kabhi Khushi Kabhie Gham', 'Drama', '2001-12-14', 'Karan Johar', 210, 'Hindi', 7.4, 400000000, 136000000),
(5, 'Lagaan', 'Drama', '2001-06-15', 'Ashutosh Gowariker', 224, 'Hindi', 8.1, 250000000, 6500000),
...
(8, 'PK', 'Comedy', '2014-12-19', 'Rajkumar Hirani', 153, 'Hindi', 8.1, 850000000, 8350000000),
...
(14, 'Bajrangi Bhaijaan', 'Drama', '2015-07-17', 'Kabir Khan', 159, 'Hindi', 8.0, 900000000, 9690000000),
...
alter table movies_info add country varchar(20);
